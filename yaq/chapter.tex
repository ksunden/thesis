...
\begin{figure}
	\includegraphics[width=0.8\columnwidth]{yaq/images/network}
...
\begin{figure}
\includegraphics[width=0.8\columnwidth]{yaq/images/client_spectrum}
	\caption{  \label{yaq:fig:foundation} \yaq{} scales from simple scripts to integrations with featureful frameworks.}
\end{figure}

A \yaq{} client can scale in complexity from a small, lightweight script all the way to a sophisticated graphical program, as shown in Figure \ref{yaq:fig:foundation}.
